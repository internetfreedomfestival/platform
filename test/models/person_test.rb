...
class PersonTest < ActiveSupport::TestCase
  ...
  test '.to_csv' do
    ...
    assert_equal person.professional_background.to_s, first_row[PROFESSIONAL_BACKGROUND]
    ...
    assert_equal person_with_invitation_and_ticket.professional_background.to_s, second_row[PROFESSIONAL_BACKGROUND]
    assert_nil second_row[ORGANIZATION]
    assert_nil second_row[PROJECT]
    assert_nil second_row[TITLE]
    assert_equal ticket.iff_before.to_s, second_row[ATTENDED_BEFORE]
    ...
    assert_equal ticket.iff_goals.to_s, second_row[GOALS]
    ...
    assert_equal person_with_invitation_and_event.professional_background.to_s, third_row[PROFESSIONAL_BACKGROUND]
