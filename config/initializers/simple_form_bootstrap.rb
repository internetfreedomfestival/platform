...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_string, tag: 'div', class: 'clearfix form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'clearfix form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
  ...
  config.wrappers :check_boxes, tag: 'div', class: 'inputs-list clearfix form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label
